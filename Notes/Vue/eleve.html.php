...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
  ...
  <a class="navbar-brand text-white" href="/niveau/"><b>NIVEAU</b></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editModalLabel">Ajouter Eleve</h5>
      ...
      <!-- Formulaire de modification -->
        <form method="POST" action="/classe/addclasse"> 
          ...
          <?php foreach($eleves as $eleve):?>
              <input type="hidden"  class="form-control" name="id_niveau_classe" value="<?php  echo $celeve['id_eleve'];?>">
          <?php endforeach ?>
